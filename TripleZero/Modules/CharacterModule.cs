...
namespace TripleZero.Modules
{
    ...
    {        
        ...
        public async Task GetCharacterStatsCompare(string player1UserName, string player2UserName, string characterAlias)
        {
            ...
            {
                strAbilities += string.Format("\n{0} {1}/{2} v {3}/{4}", character1.Abilities[i].Name, character1.Abilities[i].Level, character1.Abilities[i].MaxLevel, character2.Abilities[i].Level, character2.Abilities[i].MaxLevel);
            }
            retStr += strAbilities;
